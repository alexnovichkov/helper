...
//числовой литерал. Это возможно с помощью суффиксов, добавляемых к записи литерала (см. ниже).
...
auto l3 = 1844'6744'0737'0955'0592uLL; //unsigned long long int
...
char c1 = '\333'; //символ с номером 333 в восьмеричной системе счисления (219 в десятичной)
char c2 = '\0';   //символ с номером 0 
char c3 = '\x0A';   //символ с номером A в 16-ричной системе счисления (10 в десятичной)
char c4 = '\xFF';   //символ с номером FF в 16-ричной системе счисления (255 в десятичной)
wchar_t c5 = L'\uFEFF'; //символ с номером 65279
...
//Составные типы включают указатели, ссылки, функции, массивы.
