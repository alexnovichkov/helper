...
void useFormatting()
{
    ...
    out.setf(std::ios::dec); //следующее число/числа будут прочитаны/записаны в десятичной системе счисления
    out.setf(std::ios::hex); //следующее число/числа будут прочитаны/записаны в 16-ричной системе счисления
    out.setf(std::ios::oct); //следующее число/числа будут прочитаны/записаны в 8-ричной системе счисления
    //- вывод плюса
